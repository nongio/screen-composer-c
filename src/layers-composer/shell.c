...
#include "sc-layer-shell-timing.h"
			  ...
			  uint32_t id)
{
	...
	struct wl_resource *resource = wl_resource_create(
		wl_client, &sc_shell_unstable_v1_interface, version, id);
	if (resource == NULL) {
 ...
 */
void
shell_handle_get_compositing_filter(struct wl_client *client,
 ...
 */
void
shell_handle_destroy(struct wl_client *client, struct wl_resource *resource)
{
}
